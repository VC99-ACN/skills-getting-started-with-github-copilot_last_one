...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, train, and compete in friendly swim meets",
    ...
    "Science Olympiad": {
        "description": "Participate in science challenges and competitions",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["maya@mergington.edu", "oscar@mergington.edu"]
    },
    "Math Club": {
        "description": "Solve puzzles, study math concepts, and prepare for contests",
